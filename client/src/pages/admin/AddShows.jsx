...
import { Heart, StarIcon, CheckIcon, DeleteIcon } from "lucide-react";
...
const AddShows = () => {
    ...
    return nowPlayingMovies.length > 0 ? (
        <>
                        ...
                        duration-300 `} onClick={() => setSelectedMovie(movie.id)}>
                            <div className="relative rounded-lg overflow-hidden">
                                ...
                                w-full absolute bottom-0 left-0">
                                    ...
                                    <p className="flex items-center gap-1 text-gray-300">{kConverter(movie.vote_count)}
                                         <Heart className="w-4 h-4 text-primary fill-primary"/></p>
                                </div>
                            </div>
            ...
            <div className="mt-8">
                <label clasName="block text-sm font-medium mb-2">Show Price</label>
